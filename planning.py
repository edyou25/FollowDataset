...
def main():
    ...
    default_ckpt = Path(
        "/home/yyf/IROS2026/diffusion_policy/data/outputs/2026.01.14/09.55.42_train_diffusion_unet_lowdim_guide_guide_lowdim/checkpoints/epoch=0140-test_mean_score=0.006.ckpt"
    )
